...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[90vh] md:min-h-[150vh]  md:translate-y-[4rem] flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.5] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-black text-5xl md:text-6xl font-bold mb-20 text-center"
      >
        {title || (
          <div className="flex flex-col space-y-[1.5rem]">
            <p className="translate-x-[0.7rem] md:translate-x-[0rem]">
                <motion.span className="pr-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>Hey</motion.span>
                <motion.span className="bg-clip-text text-transparent bg-gradient-to-b drop-shadow-md from-harvest-gold-600 to-harvest-gold-800"
                             initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay:0.2, duration: 0.5 }}>email</motion.span> 
                <motion.span className="pr-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay:0.4, duration: 0.5 }}>,</motion.span> 
                <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay:0.6, duration: 0.5 }}>meet</motion.span> 
            </p>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.0, duration: 0.5 }}>
                <Image src="logo.svg" alt="Mateo" width={300} height={300} className="translate-x-[2rem] md:translate-x-[4rem]"/>
            </motion.div>
          </div>
